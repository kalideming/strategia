...
Event.create(schedule_id: taylorsched.id, start: Time.new(2023, 2, 20, 9), end: Time.new(2023, 2, 20, 11), hours_taken: 2, title: "Meeting w/ Board", description: "Proposal for something fancy I guess idk", personal: false, work: true, project: false)
Event.create(schedule_id: jeffsched.id, start: Time.new(2023, 2, 21, 13), end: Time.new(2023, 2, 21, 14), hours_taken: 1, title: "Kid's Recital", description: "Violin strings being mutilated in a cacophonous room by sticky kids", personal: true, work: false, project: false)
Event.create(schedule_id: alexsched.id, start: Time.new(2023, 2, 22, 10, 30), end: Time.new(2023, 2, 22, 12, 30), hours_taken: 2, title: "Review CAD drawings", description: "Look at the drawings and say a lot of serious mhms", personal: false, work: false, project: true)
Event.create(schedule_id: sarahsched.id, start: Time.new(2023, 2, 23, 14), end: Time.new(2023, 2, 23, 15), hours_taken: 1, title: "Vet appointment", description: "Pup has a v stinky yeast infection in her ear", personal: true, work: false, project: false)
Event.create(schedule_id: tyransched.id, start: Time.new(2023, 2, 24, 8, 45), end: Time.new(2023, 2, 24, 10), hours_taken: 2, title: "Random Seminar", description: "Seminars seem like a place where dreams go to die", personal: false, work: true, project: false)
Event.create(schedule_id: danasched.id, start: Time.new(2023, 2, 20, 15), end: Time.new(2023, 2, 20, 16), hours_taken: 1, title: "Doctor Appointment", description: "Checkup at OBGYN", personal: true, work: false, project: false)